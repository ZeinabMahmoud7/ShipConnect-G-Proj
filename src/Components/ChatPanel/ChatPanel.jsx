...
>
            ...
            <div className="space-y-2 px-3 pb-3 max-h-[300px] md:max-h-[calc(100vh-200px)] overflow-y-auto">
              <div
  className={`bg-[#fdfbfa] rounded-lg overflow-y-auto transition-all duration-300 md:block ${
    sidebarOpen ? 'block' : 'hidden'
  }`}
/>
  ...
  setSidebarOpen(false);
      ...
      className={`cursor-pointer px-3 py-2 rounded-xl flex items-center gap-3 ${
        id === activeId
          ? 'bg-secondryOrange'
