...
const data = [
  { month: '1', late: 50, onTime: 50 },
  { month: '2', late: 45, onTime: 52 },
  { month: '3', late: 48, onTime: 54 },
  { month: '4', late: 55, onTime: 78 },
  { month: '5', late: 80, onTime: 85 },
  { month: '6', late: 20, onTime: 25 },
  { month: '7', late: 65, onTime: 70 },
  { month: '8', late: 75, onTime: 80 },
  { month: '9', late: 60, onTime: 65 },
  { month: '10', late: 50, onTime: 55 },
  { month: '11', late: 45, onTime: 50 },
  { month: '12', late: 35, onTime: 40 },
];
  ...
  return (
    <>
      <h3 className="text-base sm:text-lg font-medium ms-16 md-ms-16 text-gray-900 flex items-center gap-2">
        ...
        <span className='text-primaryBlue font-normal text-2xl'>On-Time vs. Delayed Deliveries</span>
      </h3>
