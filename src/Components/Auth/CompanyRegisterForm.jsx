...
export default function CompanyRegisterForm() {
  ...
  const onSubmit = async (data) => {
    const formData = {
      ...
      transportType: Number(data.transportType),
      shippingScope: Number(data.shippingScope),
    ...
    try {
      ...
      await axios.post('/api/Account/register/shippingCompany', formData);
    ...
    <div className="min-h-screen flex items-center justify-center bg-white">
      <div className="w-full max-w-4xl p-6 md:p-12 bg-[#7EADE7] rounded-2xl shadow-lg">
        ...
        <form className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm" onSubmit={handleSubmit(onSubmit)}>
          {/* Company Name */}
          <div>
            <label className="block text-sm mb-1 text-[#102C57]">Company Name *</label>
            <div className="flex items-center border rounded-2xl px-3 py-2 bg-white" style={{ borderColor: "#204C80" }}>
              ...
              })} placeholder="Enter your Company Name" className="w-full bg-transparent outline-none text-sm" />
            </div>
          ...
          {/* License Number */}
          <div>
            <label className="block text-sm mb-1 text-[#102C57]">Licenses Number *</label>
            <div className="flex items-center border rounded-2xl px-3 py-2 bg-white" style={{ borderColor: "#204C80" }}>
              <div className="text-gray-500 mr-2" >
                <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <input {...register('licenseNumber', {
                required: 'City is required',
                minLength: { value: 1, message: 'Must be at least 1 character' },
                maxLength: { value: 100, message: 'Must be at most 50 characters' }
              })} type="text" placeholder="Enter license Number" className="w-full bg-transparent outline-none" />
            </div>
            {errors.licenseNumber && <p className="text-xs text-red-500 flex items-center pr-3 flex"><IoAlertCircleSharp className='text-sm mr-1' />{errors.licenseNumber.message}</p>}
          </div>

          {/* Shipping Scope */}
          <div>
            <label className="block text-sm mb-1 text-[#102C57]">Shipping Scope *</label>
            <div className="flex items-center border rounded-2xl px-3 py-2 bg-white" style={{ borderColor: "#204C80" }}>
              <div className="text-gray-500 mr-2" >
                <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <select {...register('shippingScope', {
                required: 'Please select a shipping Scope',
                minLength: { value: 1, message: 'Invalid Scope' },
            ...
            {errors.shippingScope &&
              <p className="text-xs text-red-500 flex items-center pr-3 flex">
                <IoAlertCircleSharp className='text-sm mr-1' />{errors.shippingScope.message}</p>
            }
          </div>

          {/* Transport Type */}
          <div>
            <label className="block text-sm mb-1 text-[#102C57]">Transport Type *</label>
            <div className="flex items-center border rounded-2xl px-3 py-2 bg-white" style={{ borderColor: "#204C80" }}>
              <div className="text-gray-500 mr-2" >
              ...
              <select {...register('transportType', {
                ...
                minLength: { value: 1, message: 'Invalid Type' },
                maxLength: { value: 100, message: 'Too long' }
              })} className="w-full bg-transparent outline-none">
            ...
            {errors.transportType &&
              <p className="text-xs text-red-500 flex items-center pr-3 flex">
                <IoAlertCircleSharp className='text-sm mr-1' />{errors.transportType.message}</p>
            }
          </div>
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            >
              {loading ? 'Registering...' : 'Register as Shipping Company'}
            </button>
          </div>
        </form>
      </div>
